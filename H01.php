...
<html lang="en">
  ...
  <body>
    <div class="container">
        <div class="row">
            <div class="col-sm-4"><img src="fkgh/devlin.jpg" alt=""></div>
            <div class="col-sm-4"><img src="fkgh/freeland.jpg" alt=""></div>
            <div class="col-sm-4"><img src="fkgh/gabriel.jpg" alt =""></div>
            <div class="col-sm-4"><img src="fkgh/pete.jpg" alt=""></div>
            <div class="col-sm-4"><img src="fkgh/peterus.jpg" alt=""></div>
            <div class="col-sm-4"><img src="fkgh/prentice.jpg" alt=""></div>
        </div>
    </div>
...
"1N6AA0EDXFN868772", "WBADW3C59DJ422810") ;
    ...
    echo "Autoid :" .count($cars)."<br>";
    if(count($cars) == count($vins)){
        echo "Autod ja Vinid klapivad <br>";
    } else {
         echo "Autod ja Vinid el klapivad <br>";
    }
    ...
    <h2>Tüdrukud</h2>
    <?php 
	    $nimed = array('mari', 'kati', 'malle', 'minni', 'liisa', 'karin', 'kerli','annette');
        sort($nimed);
